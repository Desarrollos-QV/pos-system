                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="ApiKey_google" class="form-control" value="{{$lims_general_setting_data->ApiKey_google}}">
                                </div>
                            </div>       
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="fb" class="form-control" value="{{$lims_general_setting_data->fb}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Instagram</label>
                                    <input type="text" name="insta" class="form-control" value="{{$lims_general_setting_data->insta}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Youtube</label>
                                    <input type="text" name="youtube" class="form-control" value="{{$lims_general_setting_data->youtube}}">
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Twitter</label>
                                    <input type="text" name="twitter" class="form-control" value="{{$lims_general_setting_data->twitter}}">
                                </div>
                            </div>   
                        </div>
